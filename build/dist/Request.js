...
var _RequestError = _interopRequireDefault(require("./RequestError.js"));
...
var Request = /*#__PURE__*/function (_Emitter) {
  ...
  _createClass(Request, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (typeof url !== "string") new _RequestError["default"]("'".concat(url, "' is not String."), {
                name: "TypeError"
              })["throw"]();
              _URL = new URL(url), protocol = _URL.protocol, hostname = _URL.hostname, port = _URL.port, path = _URL.path;
              __module = protocol === "https" ? _nodeHttps["default"] : _nodeHttp["default"];
              if (!(options !== null && options !== void 0 && options.headers) || _typeof(options === null || options === void 0 ? void 0 : options.headers) !== "object") options.headers = {};
              __options = {
              ...
              promise = new Promise(function (resolve, reject) {
                var request = __module.request(__options, function (response) {
                  var __data = null;
                ...
                if (options !== null && options !== void 0 && options.data) request.write(options.data);
                request.end();
              });
              _context.next = 9;
              return promise;
    ...
    key: "patch",
    value: function () {
      var _patch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(url) {
        var options,
          req,
          _args4 = arguments;
    ...
    key: "head",
    value: function () {
      var _head = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(url) {
        var options,
          req,
          _args5 = arguments;
    ...
    key: "trace",
    value: function () {
      var _trace = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(url) {
        var options,
          req,
          _args6 = arguments;
