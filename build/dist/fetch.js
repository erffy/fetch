...
function _fetch() {
  _fetch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url) {
    var _type;
    var options,
      type,
      __response,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (url && typeof url !== "string") new _RequestError["default"]("'".concat(url, "' is not String."), {
            name: "TypeError"
          })["throw"]();
          _context.next = 6;
        ...
        case 35:
          ...
          return _context.abrupt("return", _context.t6.from.call(_context.t6, _context.t7));
        case 39:
          if (!(type === "PLAIN")) {
            _context.next = 43;
            break;
          }
          return _context.abrupt("return", __response);
        case 43:
          if (!(type === "TEXT")) {
            _context.next = 49;
            break;
        ...
        case 46:
          return _context.abrupt("return", _context.sent);
        case 49:
          new _RequestError["default"]("'".concat(type, "' is not supported."), {
            name: "InvalidType"
          })["throw"]();
        case 50:
        case "end":
